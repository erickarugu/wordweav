...
// PostgreSQL connection (new database) - explicitly use PostgreSQL URL
const postgresClient = new PrismaClient({
  datasources: {
    db: {
      url:
        process.env.DATABASE_URL ||
        "postgresql://postgres:admin@localhost:5432/wordweaves?sslmode=disable",
    },
  },
});
...
export { migrateTables, verifyMigration };
