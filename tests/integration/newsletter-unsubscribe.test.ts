...
describe('/api/newsletter/unsubscribe', () => {
  ...
  describe('POST', () => {
    test('successfully unsubscribes existing active subscriber', async () => {
      ...
      mockPrisma.newsletterSubscriber.findUnique.mockResolvedValue(activeSubscriber)
    ...
    test('handles already unsubscribed email', async () => {
      ...
      mockPrisma.newsletterSubscriber.findUnique.mockResolvedValue(inactiveSubscriber)
