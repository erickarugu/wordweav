  ...
  const loadProfileData = async () => {
    try {
      ...
      if (accountsRes.ok) {
        ...
        setConnectedAccounts(accountsData.providers);
      }
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-4">
                      ...
                      <button
                        onClick={() => {
                          if (session?.user?.email) {
                            ...
                            window.location.href = `/api/auth/signin/google?callbackUrl=${encodeURIComponent("/profile")}`;
                          }
                        }}
                  ...
                  <div className="text-sm text-gray-500">
                    <p>
                      <strong>Note:</strong> Connecting your Google account will
                      allow you to sign in with either your email/password or
