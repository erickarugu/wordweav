...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 relative overflow-hidden flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-orange-200/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-4 mb-2">Welcome Back</h2>
